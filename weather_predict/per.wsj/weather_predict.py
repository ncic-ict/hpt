...
# fit network
LSTM = model1.fit(train_X, train_y, epochs=100, batch_size=32, validation_data=(valid_X, valid_y), verbose=2,
                  shuffle=False)
...
# step5: 模型预测及可视化
plt.figure(figsize=(24, 8))
train_predict = train_y #model1.predict(train_X)
valid_predict = valid_y#model1.predict(valid_X)
test_predict = test_y #model1.predict(test_X)
