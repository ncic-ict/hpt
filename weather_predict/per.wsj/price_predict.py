...
def train():
    ...
    test_X, test_y = test[:-61, :-1], test[:-61, -1]
    ...
    for i in range(60):
        ...
        aaa = test_X1[0][0]
        test_X1[0][0] = test_predict_y[0][0]
    ...
    plt.plot([None for _ in train_predict] + [None for _ in valid_predict] + [x for x in test_predict]+ [x for x in test_predict], c='r')
    plt.show()
